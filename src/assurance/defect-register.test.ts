...
describe('defect register projection', () => {
  it('projects closed historical defects and the current open P1', () => {
    ...
    expect(defectRegister.records.some((record) => record.id === 'DEF-2026-003' && record.severity === 'P1' && record.status === 'Open')).toBe(true)
