...
describe('defect register projection', () => {
  it('projects closed historical defects and the current open release-governance recovery defect', () => {
    ...
    expect(defectRegister.records.some((record) => record.id === 'DEF-2026-005' && record.severity === 'P1' && record.status === 'Open')).toBe(true)
