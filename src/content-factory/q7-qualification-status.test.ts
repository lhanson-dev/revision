...
describe('Content Factory Reliability v2 status after Confirmation Pilot #19', () => {
  it('pauses paid full-course eligibility while the reusable Assessment Item correction is requalified', () => {
    expect(qualification).toMatchObject({
      schemaVersion: 1,
      status: 'paused',
      livePilotEligible: false,
      qualifiedEvidence: null,
      providerFreeQualificationEvidence: 'content-factory/reliability-pilot19-assessment-architecture-review.json',
    })
