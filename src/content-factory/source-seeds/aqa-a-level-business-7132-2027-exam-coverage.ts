...
export const AQA_A_LEVEL_BUSINESS_7132_2027_EXAM_OBLIGATIONS: FoundationExamCoverageObligation[] = [
  ...
  obligation(
    ...
    'Current AQA assessment-objective weightings use the full qualification total as the percentage denominator. Overall qualification weighting: AO1 22–25%, AO2 24–27%, AO3 25–28%, AO4 23–26%. Component weightings, expressed as percentage contributions to that qualification total: Paper 1: AO1 9–11%, AO2 9–11%, AO3 5–8%, AO4 5–8%. Paper 2: AO1 6–8%, AO2 8–11%, AO3 8–11%, AO4 6–9%. Paper 3: AO1 5–8%, AO2 5–7%, AO3 9–12%, AO4 9–12%. These component figures are not within-paper percentages.',
    [
      'AO1 22-25%', 'AO2 24-27%', 'AO3 25-28%', 'AO4 23-26%',
      'Paper 1: AO1 9-11%, AO2 9-11%, AO3 5-8%, AO4 5-8%',
      'Paper 2: AO1 6-8%, AO2 8-11%, AO3 8-11%, AO4 6-9%',
      'Paper 3: AO1 5-8%, AO2 5-7%, AO3 9-12%, AO4 9-12%',
      'qualification total',
      'not within-paper percentages',
    ],
    ['aqa-7132-scheme'],
  ),
  obligation(
