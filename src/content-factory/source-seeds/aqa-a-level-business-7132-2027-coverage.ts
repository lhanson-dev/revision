...
const sourceRequirements: SourceRequirement[] = [
  ...
  source('aqa-3-7-6', '3.7.6', ['3.7 Strategic position', 'Social and technological change'], 'Demographic/social/online change, CSR reasons/pressures and Carroll, plus technological impacts.', ['migration', 'consumer lifestyle', 'online businesses', 'Corporate Social Responsibility', 'stakeholder', 'shareholder', 'Carroll', 'technological change']),
