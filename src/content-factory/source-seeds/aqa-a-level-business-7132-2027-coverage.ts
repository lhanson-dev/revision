...
const sourceRequirements: SourceRequirement[] = [
  ...
  source('aqa-3-1-2', '3.1.2', ['3.1 What is business?', 'Business forms'], 'Business forms, ownership, shareholder role/investment, liability, shareholder finance and share-price implications.', ['sole traders', 'private limited companies', 'public limited companies', 'public sector', 'non-profit', 'social enterprises', 'unlimited liability', 'limited liability', 'ordinary share capital', 'market capitalisation', 'dividends', 'shareholders', 'share price']),
  ...
  source('aqa-3-2-1', '3.2.1', ['3.2 Managers, leadership and decision making', 'Management and leadership'], 'Management/leadership distinction, styles, influences on styles, Tannenbaum-Schmidt and situational effectiveness.', ['autocratic', 'paternalistic', 'democratic', 'laissez-faire', 'Tannenbaum Schmidt']),
  source('aqa-3-2-2', '3.2.2', ['3.2 Managers, leadership and decision making', 'Management decision making'], 'Scientific/data-led and intuitive decision making, decision trees and the complete specified decision influences.', ['decision trees', 'expected value', 'net gains', 'risks', 'rewards', 'uncertainty', 'opportunity cost', 'mission', 'objectives', 'ethics', 'external environment', 'competition', 'resource constraints']),
  ...
  source('aqa-3-4-3', '3.4.3', ['3.4 Operational management', 'Efficiency and productivity'], 'Capacity, efficiency/productivity improvement and difficulty, lean production, resource mix and technology.', ['Just in Time', 'Just in Case', 'lean production', 'labour intensive', 'capital intensive', 'efficiency', 'labour productivity', 'capacity']),
  ...
  source('aqa-3-5-2', '3.5.2', ['3.5 Financial management', 'Financial performance'], 'Budgets, cash-flow forecasts, break-even, profitability and cash-timing analysis, including their decision value.', ['variance', 'adverse', 'favourable', 'break-even', 'margin of safety', 'contribution per unit', 'total contribution', 'gross profit', 'profit from operations', 'profit for the year', 'payables', 'receivables']),
  ...
  source('aqa-3-6-1', '3.6.1', ['3.6 Human resource management', 'HR objectives'], 'HR objectives, alignment of employee/employer values and soft/hard HRM.', ['employee engagement', 'talent development', 'training', 'diversity', 'employee and employer values', 'number', 'skills', 'location', 'soft', 'hard']),
  source('aqa-3-6-2', '3.6.2', ['3.6 Human resource management', 'HR performance'], 'Calculate and interpret required HR performance measures and use them for decision making and planning.', ['labour turnover', 'labour productivity', 'employee costs as percentage of turnover', 'labour cost per unit']),
  source('aqa-3-6-3', '3.6.3', ['3.6 Human resource management', 'Organisational design and HR flow'], 'Required organisation structures/design influences and value, plus human-resource flow.', ['functional', 'product-based', 'regional', 'matrix', 'authority', 'span', 'hierarchy', 'delegation', 'centralisation', 'decentralisation', 'human resource plan', 'recruitment', 'training', 'redeployment', 'redundancy']),
  source('aqa-3-6-4', '3.6.4', ['3.6 Human resource management', 'Motivation and engagement'], 'Current required motivation theories, benefits of motivation/engagement, financial/non-financial methods and influences on their effectiveness.', ['Taylor', 'Maslow', 'Herzberg', 'piece rate', 'commission', 'salary', 'performance-related pay', 'empowerment', 'team working', 'flexible working', 'job enrichment', 'job rotation']),
  source('aqa-3-6-5', '3.6.5', ['3.6 Human resource management', 'Employer-employee relations'], 'Employee involvement, representation, communication, relations and the value of good employer-employee relations.', ['trade unions', 'works councils', 'communication', 'relations']),

  source('aqa-3-7-1', '3.7.1', ['3.7 Strategic position', 'Mission objectives and strategy'], 'Mission, internal/external influences on objectives, corporate/functional links, short-termism, strategy/tactics and SWOT.', ['short termism', 'ownership', 'external environment', 'internal environment', 'strategy', 'tactics', 'functional objectives', 'SWOT']),
  source('aqa-3-7-2', '3.7.2', ['3.7 Strategic position', 'Financial ratio analysis'], 'Required strategic financial ratios, financial-statement use and comparative interpretation.', ['return on capital employed', 'current ratio', 'gearing', 'payables days', 'receivables days', 'inventory turnover']),
  source('aqa-3-7-3', '3.7.3', ['3.7 Strategic position', 'Overall performance'], 'Non-financial performance, core competences, time/comparator analysis and Triple Bottom Line.', ['operations', 'human resource', 'marketing', 'core competences', 'short-', 'long-term', 'Elkington', 'Triple Bottom Line', 'Profit', 'People', 'Planet']),
  ...
  source('aqa-3-7-6', '3.7.6', ['3.7 Strategic position', 'Social and technological change'], 'Demographic changes and population movements, including but not limited to the named social-change examples, plus CSR reasons/pressures and technological impacts on strategic and functional decision making.', ['demographic changes', 'population movements', 'migration', 'consumer lifestyle', 'buying behaviour', 'online businesses', 'strategic and functional decision making', 'Corporate Social Responsibility', 'stakeholder', 'shareholder', 'Carroll', 'technological change']),
  source('aqa-3-7-7', '3.7.7', ['3.7 Strategic position', 'Competitive environment'], 'Porter Five Forces, how/why forces change and implications for strategy/profit.', ['Porter', 'entry threat', 'buyer power', 'supplier power', 'rivalry', 'substitute threat']),
  ...
  source('aqa-3-8-1', '3.8.1', ['3.8 Strategic direction', 'Markets and products'], 'Factors influencing markets/products, Ansoff strategic-direction options, reasons for choices and their value.', ['Ansoff', 'market penetration', 'market development', 'new product development', 'diversification']),
  ...
  source('aqa-3-9-1', '3.9.1', ['3.9 Strategic methods', 'Change in scale'], 'Reasons for growth/retrenchment, scale/scope effects, functional impacts and required growth methods/types.', ['organic', 'external', 'technical', 'purchasing', 'managerial', 'economies of scope', 'diseconomies', 'synergy', 'overtrading', 'mergers', 'takeovers', 'ventures', 'franchising', 'vertical', 'horizontal', 'conglomerate']),
  source('aqa-3-9-2', '3.9.2', ['3.9 Strategic methods', 'Innovation'], 'Innovation pressures/value, innovative organisation methods, IP protection and functional impacts.', ['product', 'process innovation', 'Kaizen', 'research and development', 'intrapreneurship', 'benchmarking', 'patents', 'copyrights']),
  source('aqa-3-9-3', '3.9.3', ['3.9 Strategic methods', 'Globalisation and internationalisation'], 'Reasons/importance of globalisation, international-market attractiveness/entry, overseas sourcing/production and international management.', ['emerging economies', 'export', 'licensing', 'alliances', 'direct investment', 'off-shoring', 're-shoring', 'multinational', 'local responsiveness', 'cost reduction']),
  ...
  source('aqa-3-10-1', '3.10.1', ['3.10 Strategic change', 'Managing change'], 'Types/value of change, flexible organisations, knowledge/information management and resistance using current required models.', ['internal change', 'external change', 'incremental change', 'disruptive change', 'Lewin', 'restructuring', 'delayering', 'flexible employment contracts', 'organic', 'mechanistic', 'knowledge', 'information management', 'Kotter and Schlesinger']),
  ...
  source('aqa-annex-quantitative', 'Annex: quantitative skills in business', ['Quantitative skills annex'], 'Course Truth must preserve the complete AQA quantitative-skills universe, not merely named formulas: numerical operations, graphical construction/interpretation, mixed-evidence decision making and written/graphical/numerical analysis, together with the Level 2 mathematical-skill assessment boundary.', ['ratios', 'averages', 'fractions', 'percentages', 'percentage changes', 'standard graphical forms', 'index numbers', 'cost', 'revenue', 'profit', 'break-even', 'investment appraisal', 'price and income elasticity', 'quantitative and non-quantitative information', 'make decisions', 'written', 'graphical', 'numerical', 'Level 2 mathematical skills', '10%']),
]
