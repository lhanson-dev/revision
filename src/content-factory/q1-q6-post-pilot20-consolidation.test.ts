...
describe('Content Factory post-Pilot #20 Q1-Q6 consolidation', () => {
  it('preserves the approved-main historical consolidation while current Pilot #21 has completed Q8', () => {
  ...
  it('preserves the historical Q7 trigger guard while current Pilot #21 Q8 is separately qualified', () => {
    ...
    expect(qualification.reason).toMatch(/Q8 transition binds qualification/i)
