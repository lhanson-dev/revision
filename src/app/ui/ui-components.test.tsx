...
describe('Revision reusable interface components', () => {
  ...
  it('selects canonical theme-paired brand assets rather than redrawing identity', () => {
    ...
    expect(wordmark.light).toContain('revision-wordmark-primary-light')
    expect(wordmark.dark).toContain('revision-wordmark-primary-dark')
    expect(livingE.light).toContain('revision-rev-living-e-nav-light')
    expect(livingE.dark).toContain('revision-rev-living-e-nav-dark')
