...
18. **When a governed change reaches confirmed production, the completion response must include concise Founder-facing release notes in plain, non-technical language. State what changed, what was improved or fixed, who or what is affected, whether there was no user-facing product change, and any material follow-up or deliberately excluded scope. Technical identifiers may be included separately for traceability but must not substitute for the plain-language summary. Release-note reporting happens after production evidence is green: it is not an additional release gate, approval step, deployment dependency or reason to delay path-to-live.**
19. **Before asking the Founder to approve any PR merge, the approval request must include a concise Founder-facing merge summary in plain, non-technical language. State what will change if the PR is merged, what problem it solves or improvement it makes, who or what is affected, whether there is no user-facing product change, and any material risk, limitation, follow-up or deliberately excluded scope. Confirm the relevant assurance and documentation position in simple terms. Technical identifiers may be included separately for traceability but must not substitute for the explanation. The explicit approval command must come after this summary so the Founder can make an informed decision. If the material PR delta changes after the summary, provide an updated summary and obtain renewed approval where required by rule 17. This communication requirement is not a second approval or an additional release gate.**
