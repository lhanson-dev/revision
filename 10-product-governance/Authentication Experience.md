...
The experience choice must be presented on a dedicated post-registration screen using **three clear, visually designed interactive cards/boxes** — one for Student, one for Parent and one for Teacher.
