...
Use this file to find the governing source before substantive work.

## Migration
- Existing-repository adoption instructions → `MIGRATING_EXISTING_PROJECT.md`
- Existing repository workflow → `80-company-workflows/Existing Repository Adoption Workflow.md`
- What knowledge exists today? → `90-governance-registers/Knowledge Estate Inventory.md`
...
- Technical decision history → `decisions/ADR-0001-frontend-stack.md` through `decisions/ADR-0018-fourth-release-lineage-recovery-and-hard-merge-enforcement.md`
