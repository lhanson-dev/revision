...
export const atlasOutdoorCase = caseStudySchema.parse({
  ...
  bodyHtml: 'Atlas Outdoor plc sells hiking clothing in the UK and several European markets. Revenue has grown, but exchange-rate movements and shipping disruption have made imported material costs volatile. The business is considering switching part of its supply chain to higher-cost certified sustainable suppliers. Marketing research suggests younger customers value environmental credentials, but price competition is intense. Atlas is also considering closing one UK warehouse and using a larger automated distribution centre in the Netherlands.',
  facts: ['PLC','International exposure','Exchange-rate risk','Shipping disruption','Sustainable supplier option','Price competition intense','Warehouse consolidation proposal','Automation and location decision'],
  questions: [
    { id: 'atlas-q1', prompt: 'Explain one way exchange-rate movements could affect Atlas Outdoor’s decisions.', guidance: 'If imported inputs become more expensive in sterling, margins/costs can worsen; management may change prices, suppliers, hedging behaviour or sourcing. Keep the chain contextual.' },
    ...
    { id: 'atlas-q3', prompt: 'Analyse one possible drawback of warehouse consolidation.', guidance: 'Automation/scale may reduce unit cost, but concentration can reduce resilience, increase implementation risk or worsen delivery to some markets. Link to customer service and working capital where useful.' },
