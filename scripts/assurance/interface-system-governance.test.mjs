...
describe('Revision Interface System governance', () => {
  ...
  it('requires migrated interface layers to consume central typography and theme roles', () => {
    ...
    expect(interfaceComponents).toContain('[data-theme="dark"] .ui-brand-asset__image--dark')
    expect(interfaceComponents).toContain('[data-theme="dark"] .ui-brand-asset__image--light')
